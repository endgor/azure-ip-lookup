...
export default function TenantInsightsComingSoon() {
  return (
    <Layout
      title="Tenant Insights"
      description="A forthcoming Azure Hub tool for exploring tenant metadata, custom domains, and subscription footprints."
    >
      <section className="rounded-2xl border border-slate-800/80 bg-slate-900/60 p-10 text-center shadow-xl shadow-slate-950/30">
        ...
        <h1 className="mt-6 text-3xl font-semibold text-slate-100">Tenant Insights</h1>
        <p className="mt-3 text-sm text-slate-300">
          We&apos;re building a guided experience to surface Azure AD tenant metadata, domains, and subscription usage in one
          place. Stay tuned while we wire up the data layer and UX flows.
        </p>
