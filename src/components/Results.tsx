...
const Results = memo(function Results({ results, query, total }: ResultsProps) {
  ...
  return (
    ...
    >
      ...
      <div className="w-full overflow-x-auto overflow-y-visible touch-pan-x" style={{ WebkitOverflowScrolling: 'touch' }}>
        <table className="relative min-w-[1100px] w-full table-auto divide-y divide-slate-200 dark:divide-slate-700" aria-label="Azure IP Ranges">
