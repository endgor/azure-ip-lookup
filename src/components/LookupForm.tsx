  ...
  return (
    <form onSubmit={handleSubmit} className="max-w-xl mx-auto mb-8" role="search" aria-label="Azure IP Lookup">
      <div className="flex flex-col md:flex-row gap-4 mb-2">
        ...
        <button
          type="submit"
          className={`bg-blue-500 text-white px-6 py-2 rounded-lg font-medium hover:bg-blue-600 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 ${
